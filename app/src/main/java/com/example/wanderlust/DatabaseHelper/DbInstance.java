...
//            BlogObject bo = new BlogObject(_blogId,userId,blogTitle,blogLocation,blogText,blogLat,blogLong,blogLikes,new ArrayList<String>(), "");
//            return bo;
//        }else{
//            return null;
//        }
...
//    }
//
//    public HashMap<String, String> verifyUser (String email, String password) {
//        Log.i(TAG, "verify user - login : called");
//        SQLiteDatabase db = this.getWritableDatabase();
//        db.beginTransaction();
//        final String VERIFY_LOGIN ="SELECT "+USERS_COLUMN_USERID+", "+USERS_COLUMN_EMAIL+", "+USERS_COLUMN_PASSWORD+", "+USERS_COLUMN_NAME+" FROM "+ TABLE_USERS+ " WHERE "+ USERS_COLUMN_EMAIL+" = '"+email+"' AND "+ USERS_COLUMN_PASSWORD+ " = '"+password+"'";
...
//                ID = cursor.getInt(cursor.getColumnIndexOrThrow(USERS_COLUMN_USERID));
//                res.put("name", name);
